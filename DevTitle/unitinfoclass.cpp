...
int UnitInfoClass::Initialize()
{
	...
	unit[0] = { BASE_CHAR_INFO, 0, 10, 10, 0, 1, 1, 10, 100, 3, 0, 0 , 0}; //Start base
	unit[0].charInfo.Char.UnicodeChar = 920;
	unit[0].charInfo.Attributes = 0x0007;
	unit[1] = { BASE_CHAR_INFO, 0, 1, 1, 1, 2, 2, 0, 0, 0, 0, 0 , -1}; //Worker
	unit[2] = { BASE_CHAR_INFO, 0, 2, 2, 2, 2, 2, 2, 1, 1, 0, 0 , -2}; //Basic Land unit

	unit[3] = { BASE_CHAR_INFO, 0, 4, 4, 3, 1, 1, 0, 4, 0, 3, 0, 1}; //General resource building
