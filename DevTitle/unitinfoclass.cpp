...
int UnitInfoClass::Initialize()
{
	...
	unit[0] = { BASE_CHAR_INFO, 0, 10, 10, 0, 1, 10, 100, 3, 0, 0 }; //Start base
	unit[0].charInfo.Char.UnicodeChar = 233;
	unit[0].charInfo.Attributes = 0x0007;
	unit[1] = { BASE_CHAR_INFO, 0, 1, 1, 1, 2, 0, 0, 0, 0, 0 }; //Worker
	unit[2] = { BASE_CHAR_INFO, 0, 2, 2, 2, 2, 2, 1, 1, 0, 0 }; //Basic Land unit

	unit[7] = { BASE_CHAR_INFO, 0, 1, 1, 7, 100, 1000, 1000, 100, 1, 0 }; //Unit for Land testing
